...
switch(order){
    case '딸기':alert('1000원'); break;
    case '수박':alert('10000원'); break;
    case '오렌지':alert('5000원'); break;
    case '망고':alert('7000원'); break;
...
//3번 입력 시 동생
//해당 단축키가 없습니다
const callNumber = Number(window.prompt('단축키입력'));
switch(callNumber){
    case 1:alert('엄마'); break;
    case 2:alert('아빠'); break;
    case 3:alert('동생'); break;
    default:alert1('해당 단축키가 없습니다.')
}
