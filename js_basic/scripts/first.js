...
bowl = '콩'
//console.log(bowl); //콩
// 자바스크립트는 절차적 언어이기 때문에 CSS처럼 우선순위에 따라 최종결과값만 인식하는 것이 아닌 실행 함수의 작성 위치에 따라 다른 변수값을 인실할 수 있다.
var a = 1;
var b = 5;
var c= 10;
...
console.log('=========데이터공부')
var d;
console.log(typeof d)//값이 할당되지 않은 상태 underfined
d = a;
...
console.log(box4);
console.log(box4.length); //hello의 문자 개수는?
//객체.속성;
//객체.함수();
console.log('---------------')
var num1 = 10;
...
//dan99 변수에 어떤 데이터가 변경될때 함께 달라지는 결과는 ${}으로 프로그래밍식으로 처리
